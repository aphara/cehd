        ...
        <div id="light">
            <h2>Température</h2>
                ...
                <div class="input-group plus-minus-input">
                       <button type="button" class="button hollow circle change_qty minus cursor_hover" data-quantity="minus" data-field="quantity">
                           <i class="material-icons">remove_circle_outline</i>
                        </button>

                    <input class="input-group-field" type="number" name="quantity" value="<?= $temp_request; ?>" max="30" min="15" step="0.1">

                        <button type="button" class="button hollow circle change_qty plus cursor_hover" data-quantity="plus" data-field="quantity">
