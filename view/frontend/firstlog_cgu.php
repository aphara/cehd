...
Éventuellement :</p>
      <ul>
        ...
        <li>CEHD se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</li>
      </ul>
      <h2>ARTICLE 2 : Mentions légales</h2>
      <p>L'édition du site CEHD est assurée par la Société DOMISEP au capital de 1M€ dont le siège social est situé au 10 rue Vanves 92130 ISSY-LES-MOULINEAU.<br>
Le Directeur de la publication est Monsieur John SMITH</p>
      ...
      <p>Le site permet à l'Utilisateur un accès payant aux services suivants :</p>
      <ul>
        <li>[articles d’information] ;</li>
        <li>[annonces classées] ;</li>
        <li>[mise en relation de personnes] ;</li>
        <li>[publication de commentaires / d’œuvres personnelles] ;</li>
        <li>[…].</li>
      </ul>
      <p>Le site est accessible gratuitement en tout lieu à tout Utilisateur ayant un accès à Internet. Tous les frais supportés par l'Utilisateur pour accéder au service (matériel informatique, logiciels, connexion Internet, etc.) sont à sa charge.<br>
Selon le cas :<br>
...
Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de CEHD.<br>
...
L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse service.client@domisep.fr</p>
...
Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect de la vie privée conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés. Le site est déclaré à la CNIL sous le numéro [numéro].<br>
En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. L'Utilisateur exerce ce droit via :</pre>
    <ul>
      <li>son espace personnel </li>
      <li>un formulaire de contact</li>
      <li>par mail à service.client@domisep.fr </li>
      <li>par voie postale à Ervice client 10 rue Vanves 92130 ISSY-LES-MOULINEAU</li>
    </ul>
...
La responsabilité du site ne peut être engagée en cas de force majeure ou du fait imprévisible et insurmontable d'un tiers.</pre>
    <h2>ARTICLE 8 : Liens hypertextes</h2>
    <p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de CEHD qui n'a pas le contrôle de ces liens.<br>
L'Utilisateur s'interdit donc à engager la responsabilité du site concernant le contenu et les ressources relatives à ces liens hypertextes sortants.</pre>
    ...
    <p>La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux de la ville de Paris sont compétents.</p>
    <h2>ARTICLE 12 : Publication par l’Utilisateur</h2>
    <p>Le site permet aux membres de publier des commentaires.<br>
Dans ses publications, le membre s’engage à respecter les règles de la Netiquette et les règles de droit en vigueur.<br>
Le site exerce une modération a priori sur les publications et se réserve le droit de refuser leur mise en ligne, sans avoir à s’en justifier auprès du membre.<br>
...
La société éditrice s'engage à faire figurer le nom du membre à proximité de chaque utilisation de sa publication.</p>
  ...
  <form action="index.php?action=firstlog_cgu" method="post">
      <div>
          <input type="checkbox" id="acceptCGU" name="acceptcgu" value="cgu">
          <label for="acceptCGU">J'accepte les CGU du site.</label>
      </div>
      <div>
