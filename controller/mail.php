...
function sendmail_public($message_contact_public, $object_contact_public,$mail_public)
{
    $mail = 'cehddomisep@gmail.com'; // Déclaration de l'adresse de destination.
    if (!preg_match("#^[a-z0-9._-]+@(hotmail|live|msn).[a-z]{2,4}$#", $mail)) // On filtre les serveurs qui rencontrent des bogues.
    {
...
//=====Déclaration des messages au format texte et au format HTML.
    $message_txt = $message_contact_public;
    $message_html = "<html><head></head><body>$message_contact_public</body></html>";
//==========
